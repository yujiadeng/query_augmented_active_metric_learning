...
result_file=../python_file/real_data/${data_name}/max_nc_${max_nc}/comparison/rep${rep}.npz
...
python3 sequential_output_real_data_comparison.py ${data_name} ${max_nc} ${rep}
