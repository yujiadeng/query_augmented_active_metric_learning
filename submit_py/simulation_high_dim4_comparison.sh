...
result_file=../python_file/simulation_high_dim_4/P1_${P1}_P2_${P2}_mu_${mu}.0_N_per_cluster_${N_per_cluster}/max_nc_${max_nc}_/comparison/rep${rep}.npz
...
python3 sequential_output_simulation_comparison.py ${P1} ${P2} ${mu} ${N_per_cluster} ${max_nc} ${rep}
